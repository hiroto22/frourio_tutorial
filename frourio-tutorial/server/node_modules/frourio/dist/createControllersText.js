...
var createRelayFile = function (input, appText, additionalReqs, params) {
    ...
    var text = "import type { Injectable } from 'velona'\nimport { depend } from 'velona'\nimport type { FastifyInstance, onRequestHookHandler, preParsingHookHandler, preValidationHookHandler, preHandlerHookHandler } from 'fastify'\nimport type { Schema } from 'fast-json-stringify'\nimport type { HttpStatusOk } from 'aspida'\nimport type { ServerMethods } from '".concat(appText, "'\n").concat(hasMultiAdditionals
        ...
        return hasAdditionals
            ? "  ".concat(key, "?: AddedHandler<").concat(val, "> | AddedHandler<").concat(val, ">[] | undefined\n")
            : "  ".concat(key, "?: ").concat(val, " | ").concat(val, "[] | undefined\n");
    })
...
var createFiles = function (appDir, dirPath, params, appPath, additionalRequestPaths) {
    ...
    dirs.forEach(function (d) {
        var _a;
        return createFiles(appDir, path_1.default.posix.join(dirPath, d.name), d.name.startsWith('_')
...
exports.default = (function (appDir, project) {
        ...
        if (source) {
            ...
            if (methods === null || methods === void 0 ? void 0 : methods.length) {
                    ...
                    typescript_1.default.forEachChild(controllerSource, function (node) {
                        ...
                        if (typescript_1.default.isVariableStatement(node) &&
                            ...
                            if (exportClause && typescript_1.default.isNamedExports(exportClause)) {
                                ctrlHooksNode_1 =
                                    (_d = exportClause.elements.find(function (el) { return el.name.text === 'hooks'; })) !== null && _d !== void 0 ? _d : ctrlHooksNode_1;
                                resSchemaNode_1 =
                                    (_e = exportClause.elements.find(function (el) { return el.name.text === 'responseSchema'; })) !== null && _e !== void 0 ? _e : resSchemaNode_1;
                            }
                        }
                    });
                    if (ctrlHooksNode_1) {
                ...
                var genResSchemaText_1 = function (method) {
                    return "schema: { response: responseSchema".concat(controllers.filter(function (c) { return c[2]; }).length, ".").concat(method, " }");
                };
                ...
                results.push(methods
                    ...
                    var hooksTexts = ['onRequest', 'preParsing', 'preValidation', 'preHandler']
                            ...
                            var texts_1 = __spreadArray(__spreadArray(__spreadArray([
                                ...
                                validateInfo.length
                                    ? "createValidateHandler(req => [\n".concat(validateInfo
                                        .map(function (v) {
                                        return v.type
                                            ? "          ".concat(v.hasQuestion ? "Object.keys(req.".concat(v.name, " as any).length ? ") : '', "validateOrReject(plainToInstance(Validators.").concat(checker.typeToString(v.type), ", req.").concat(v.name, " as any, transformerOptions), validatorOptions)").concat(v.hasQuestion ? ' : null' : '')
                                            : '';
                                    })
                                        .join(',\n'), "\n        ])")
                                    : '',
                        ...
                        .filter(Boolean);
                    return "  fastify.".concat(m.name, "(").concat(hooksTexts.length || (resSchemaMethods_1 === null || resSchemaMethods_1 === void 0 ? void 0 : resSchemaMethods_1.includes(m.name))
                        ? '\n    '
                        : '').concat(dirPath
                        ? "`${basePath}".concat("/".concat(dirPath)
                            .replace(/\/_/g, '/:')
                            .replace(/@.+?($|\/)/g, '$1'), "`")
                        : "basePath || '/'", ",").concat(hooksTexts.length || (resSchemaMethods_1 === null || resSchemaMethods_1 === void 0 ? void 0 : resSchemaMethods_1.includes(m.name))
                        ? "\n    {\n      ".concat((resSchemaMethods_1 === null || resSchemaMethods_1 === void 0 ? void 0 : resSchemaMethods_1.includes(m.name))
                            ? "".concat(genResSchemaText_1(m.name)).concat(hooksTexts.length ? ',\n      ' : '')
                    ...
                    .join('\n'));
                controllers.push(["".concat(input, "/controller"), !!ctrlHooksEvents_1, !!resSchemaMethods_1]);
            }
        }
    ...
    return {
        imports: "".concat(hooksPaths
            ...
            .map(function (ctrl, i) {
            return "import controllerFn".concat(i).concat(ctrl[1] || ctrl[2]
                ? ", { ".concat(ctrl[1] ? "hooks as ctrlHooksFn".concat(ctrlHooks.indexOf(ctrl)) : '').concat(ctrl[1] && ctrl[2] ? ', ' : '').concat(ctrl[2] ? "responseSchema as responseSchemaFn".concat(resSchemas.indexOf(ctrl)) : '', " }")
