...
var checkRequisites_1 = __importDefault(require("./checkRequisites"));
...
exports.default = (function (input, project) {
    ...
    (0, checkRequisites_1.default)({ hasValidator: hasValidator });
    var headIpmorts = [];
    if (hasValidator) {
        headIpmorts.push("import 'reflect-metadata'", "import type { ClassTransformOptions } from 'class-transformer'", "import { plainToInstance as defaultPlainToInstance } from 'class-transformer'", "import type { ValidatorOptions } from 'class-validator'", "import { validateOrReject as defaultValidateOrReject } from 'class-validator'");
    }
    if (hasMultipart) {
        headIpmorts.push("import type { FastifyMultipartAttactFieldsToBodyOptions, Multipart } from '@fastify/multipart'");
